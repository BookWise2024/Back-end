...
public class WishlistController {
    ...
    @GetMapping
    public WishlistResponse getLibraryList(@RequestHeader("Authorization") String accessToken) {
...
//        Long userId = 1L;
    ...
    @GetMapping("/search")
    public WishlistResponse getWishlistBySearch(@RequestHeader("Authorization") String accessToken, String keyword) {
