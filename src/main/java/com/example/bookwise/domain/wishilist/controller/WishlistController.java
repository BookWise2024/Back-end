...
public class WishlistController {
    ...
    public ResponseEntity<String> createDummyDB() {
        ...
        for(int i =0;i<=9;i++) {
            Book book = new Book("U884964888"+i,"https://image.aladin.co.kr/product/58/20/coversum/8937830892_2.jpg","[중고] 밤의 피크닉","온다 리쿠 (지은이), 권남희 (옮긴이)","?몰라?","2005-09-05","북폴리오","소설","일본소설","2005년 제26회 요시카와 에이지 문학상 신인상 수상작. 일본 서점 직원들이 선정하는 제2회 서점대상 수상작이기도 하다. 1회 수상작은 국내에도 소개되어 많은 사랑을 받은 . 어린 날의 떨림과 반짝거림, 가볍게 들떠 있다가도 곧 무겁게 가라앉곤 하는 10대 시절의 공기를 예리하게 그려냈다.");
            Book book1 = new Book("U88496489"+i,"https://image.aladin.co.kr/product/58/20/coversum/8937830892_2.jpg","[중고] 밤의 댄스","온다 리쿠 (지은이), 권남희 (옮긴이)","?몰라?","2005-09-05","북폴리오","소설","일본소설","2005년 제26회 요시카와 에이지 문학상 신인상 수상작. 일본 서점 직원들이 선정하는 제2회 서점대상 수상작이기도 하다. 1회 수상작은 국내에도 소개되어 많은 사랑을 받은 . 어린 날의 떨림과 반짝거림, 가볍게 들떠 있다가도 곧 무겁게 가라앉곤 하는 10대 시절의 공기를 예리하게 그려냈다.");
        ...
        for(int i =0;i<=9;i++) {
            Book b =bookRepository.findByBookId("U884964888"+i).orElseThrow();
            Book b1 =bookRepository.findByBookId("U88496489"+i).orElseThrow();
